               ...
               <div className="container">
                  <div className="footer__top">
                     <div className="footer__nav">
                        ...
                        <a href="/">Tuyển dụng</a>
                        <a href="/">Hoàn tiền thành viên</a>
                        <a href="/">Hợp tác đại lý</a>
                     </div>
                     ...
                     <div className="footer__contact">
                        ...
                        <p className="semibold">
                           Số 10/55 Thụy Khuê, Phường Thuỵ Khuê
                        </p>
                        <p>Quận Tây Hồ, Thành phố Hà Nội</p>
                        <p>Số tài khoản: 1023431230</p>
                     ...
                     <div className="footer__form">
                        <p>
                           <strong>Du lịch thông minh!&nbsp;</strong>Đăng ký
                           nhận tin để lên kế hoạch cho kỳ nghỉ tới ngay từ bây
                           giờ:
                        </p>
                        <Form className="form">
                           <Form.Item>
